...
if (mysqli_connect_errno()) {
  ...
  $search_sql="SELECT * FROM `players` WHERE Name1 LIKE '%".$_POST['search']."%'";
...
<body>
	...
	<form>
<input type="button" value="Back" onclick="window.location.href='http://localhost/abc/search1.php'" />
</form>
...
<br>
<center>
<button type="submit" style="height: 70px ; width: 275px" name="BUY NOW">BUY NOW</button>
</center>
<?php endforeach; ?>
